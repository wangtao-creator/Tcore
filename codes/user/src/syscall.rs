...
const SYSCALL_WAITTID: usize = 261;
const SYSCALL_RENAMEAT2: usize = 276;
const SYSCALL_THREAD_CREATE: usize = 1000;
const SYSCALL_GETTID: usize = 1001;
const SYSCALL_GETPPID_WAITTOD: usize = 1002;
...
//功能创建一个新线程 entry标识线程的入口函数地址 arg 线程的一个参数
...
// tid 表示线程id 返回值 -1 代表线程不存在 -2 代表线程还没退出 其他情况下，返回结束线程的退出码
